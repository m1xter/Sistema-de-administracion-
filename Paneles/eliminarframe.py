...
class Eliminarframe:
    ...
    def menu_botones(self,master):
        ...
        self.etiqueta  = Label(master,text="ELIMINAR",bg='#0040FF', font=('Arial',15),fg='white')
    ...
    def frame_de_Ap(self,master):
        ...
        self.texto1 = Label(self.Apframe,text="Eliminar Personas",font=('Arial',20),bg='#e5e4e4',fg='black')
        ...
        self.propiedad = ttk.Entry(self.Apframe,textvariable=self.tipo,font=('Arial','12'),width=15)
        self.propiedad.config(validate='key',validatecommand=(self.Apframe.register(self.validate_entry),"%S"))
        ...
        self.actualizar_btn = Button(self.Apframe,font=('Arial','12'),bg='#0040FF',fg='white',width=20,height=1,text="Eliminar",bd=0,command= lambda : [self.click_eliminar_persona(),self.limpiar()])
    ...
    def frame_de_Aa(self,master):
        ...
        self.etiqueta1  = Label(self.Aaframe,text="Eliminar Apartamentos",font=('Arial',20),bg='#e5e4e4',fg='black')
        ...
        self.propietario = ttk.Entry(self.Aaframe,font=('Arial','12'),width=15)
        ...
        self.inquilino = ttk.Entry(self.Aaframe,font=('Arial','12'),width=15)
        ...
        self.actualizar_btn = Button(self.Aaframe,font=('Arial','12'),bg='#0040FF',fg='white',width=20,height=1,text="Eliminar",bd=0,command= lambda : [self.click_eliminar_apartamento(),self.limpiar2()])
        self.actualizar_btn.place(x=400,y=350)
    ...
    def frame_de_Ai(self,master):
        ...
        self.texto1 = Label(self.Aiframe,text="Eliminar Ingresos",font=('Arial',20),bg='#e5e4e4',fg='black')
        self.texto1.place(x=40,y=5)
        ...
        self.nro_apartamento.config(validate='key',validatecommand=(self.Aiframe.register(self.validate_entry2),"%S"))
        ...
        self.cant_dinero.config(validate='key',validatecommand=(self.Aiframe.register(self.validate_entry2),"%S")) 
        ...
        self.actualizar_btn = Button(self.Aiframe,font=('Arial','12'),bg='#0040FF',fg='white',width=20,height=1,text="Eliminar",bd=0,command= lambda : self.click_eliminar_ingreso())
    ...
    def frame_de_Ae(self,master):
        ...
        self.texto1 = Label(self.Aeframe,text="Eliminar Retiros",font=('Arial',20),bg='#e5e4e4',fg='black')
        self.texto1.place(x=40,y=5)
        ...
        self.actualizar_btn = Button(self.Aeframe,font=('Arial','12'),bg='#0040FF',fg='white',width=20,height=1,text="Eliminar",bd=0,command= lambda : self.click_eliminar_egreso())
        self.actualizar_btn.place(x=400,y=400)
    ...
    def limpiar(self):        
        ...
        self.pnombre.delete("0","end")        
        self.snombre.delete("0","end")        
        self.papellido.delete("0","end")        
        self.spellido.delete("0","end")        
        self.ntelefono.delete("0","end")        
    ...
    def click_buscar_persona(self,cedula):
        ...
        if id_persona == '':
            ...
            if info:                
                ...
                messagebox.showerror("ERROR", "no se encontro a la persona")


    
    def click_eliminar_persona(self):
        id_persona = self.id_persona.get()
        if id_persona == '':
            messagebox.showerror("ERROR", "NO DEBE INGRESAR CAMPOS VACÍOS")            
            self.eliminar_btn.config(state='disable')
            self.entry_id.config(state='normal')
        else:
            result = messagebox.askyesno("Status","¿SEGURO DE QUE DESEA ELIMAR ESTE REGISTRO?")
            if result == True:    
                if self.controlador.eliminar_persona(id_persona) == True:
    ...
    def click_eliminar_apartamento(self):
        id_aparta = self.id_aparta.get()
        if id_aparta == '':
            messagebox.showerror("ERROR", "NO DEBE INGRESAR CAMPOS VACÍOS")            
            self.eliminar_btn.config(state='disable')
            ...
            result = messagebox.askyesno("Status","¿SEGURO DE QUE DESEA ELIMAR ESTE REGISTRO?")
            if result == True:    
                if self.controlador.eliminar_apartamento(id_aparta) == True:                    
                    messagebox.showinfo("Status","ELIMINADO EXITOSAMENTE")
                    self.limpiar_caja()                    
                else:
                    self.limpiar_caja()
    ...
    def click_eliminar_ingreso(self):
        id_ingreso = self.id_ingreso
        if id_ingreso == '':
            messagebox.showerror("ERROR", "DEBES SELECCIONAR UN INGRESO DE LA TABLA")            
            self.eliminar_btn.config(state='disable')
            self.entry_id.config(state='normal')
        else:
            result = messagebox.askyesno("Status","¿SEGURO DE QUE DESEA ELIMAR ESTE REGISTRO?")
            if result == True:    
                if self.controlador.eliminar_ingreso(id_ingreso) == True:
                    messagebox.showinfo("Status","ELIMINADO EXITOSAMENTE")
    ...
    def click_eliminar_egreso(self):
        ...
        if id_egreso == '':
            ...
            result = messagebox.askyesno("Status","¿SEGURO DE QUE DESEA ELIMAR ESTE REGISTRO?")
            if result == True:    
                if self.controlador.eliminar_egreso(id_egreso) == True:
                    messagebox.showinfo("Status","ELIMINADO EXITOSAMENTE")
